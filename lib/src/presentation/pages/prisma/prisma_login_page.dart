...
class PrismaLoginPage extends StatefulWidget {
  const PrismaLoginPage({
    super.key,
  ...
  @override
  State<PrismaLoginPage> createState() => _PrismaLoginPageState();
}

class _PrismaLoginPageState extends State<PrismaLoginPage>
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AuthBloc, AuthState>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          backgroundColor: const Color(0xFFF0F4F8), // Light base
          body: Stack(
            fit: StackFit.expand,
            children: [
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _springEntrance(
                  4,
                  child: _buildSignInButton(isLoading, context),
                ),
