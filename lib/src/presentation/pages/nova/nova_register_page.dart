...
class NovaRegisterPage extends StatefulWidget {
  ...
  @override
  State<NovaRegisterPage> createState() => _NovaRegisterPageState();
}

class _NovaRegisterPageState extends State<NovaRegisterPage>
  ...
  void _handleStateChange(BuildContext context, AuthState state) {
    if (state is AuthErrorState) {
      ...
      if (mounted && widget.onLoginTap != null) {
        // Just pop back to let the flow handle showing the verification page
        widget.onLoginTap!();
